...
// dejavoo.getTxStatus({refId, paymentType: constants.PaymentType.Card, printReceipt: constants.PrintReceipt.No }).then(console.log)
// dejavoo.voidTx({ amount: 0.01, refId, paymentType: constants.PaymentType.Card }).then(console.log)
